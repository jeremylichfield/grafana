...
import { DataSourcePluginMeta, DataSourceSettings, PluginExtensionPoints } from '@grafana/data';
import { AngularComponent, getAngularLoader, getPluginElementExtensions } from '@grafana/runtime';
